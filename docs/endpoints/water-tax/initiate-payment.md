...
|----------|-------|
| **Method** | POST |
| **URL** | `/water/payment/initiate` |
| **Authentication** | Required (JWT Token) |
| **Rate Limit** | 10 requests per minute |

## Description
Initiate a payment transaction for water tax. This endpoint generates a payment URL and order ID for redirecting to the payment gateway.
...
4. **Confirmation Webhook** - Payment gateway sends confirmation
